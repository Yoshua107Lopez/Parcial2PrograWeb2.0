...
<form action="{{ route('restringidos.store')}}" method="POST" 
    class="bg-white w-1/3 p-4 border-gray-100 shadow-xl rounded-lg">
    @csrf
    
    <h2 class="text-2xl text-center py-4 mb-4 font-semibold"> Create Medicamentos Controlados</h2>
    ...
    <input class="my-2 w-full bg-gray-200 p-2 text-lg rounded placeholder-900"
    placeholder="Medic Home" name="medichome">

    <input class="my-2 w-full bg-gray-200 p-2 text-lg rounded placeholder-900"
    placeholder="Compuest Active" name="compuesactive">
