      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="p-3 flex justify-center">
            ...
            <form action="{{ route('restringidos.destroy', $row->id )}}" method="POST">
              @csrf
              @method('delete')
            ...
            <a href="{{ route('restringidos.edit', $row->id)}}" class="bg-green-500 text-white px-3 py-1 rounded-sm">
